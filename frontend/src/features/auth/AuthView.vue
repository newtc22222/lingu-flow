  ...
  <div class="auth-screen">
        ...
        <div class="auth-body">
          <form v-if="mode !== 'forgot'" class="auth-form" @submit.prevent="handleSubmit">
            ...
            <div class="arcade-field">
              ...
              <input id="auth-email" v-model="email" type="email" required placeholder="user@example.com" class="arcade-input auth-recessed-input" />
            </div>

            <div class="arcade-field">
              <label class="arcade-label" for="auth-password">{{ t('auth.password') }}</label>
              <input id="auth-password" v-model="password" type="password" required placeholder="••••••••" class="arcade-input auth-recessed-input" />
    ...
    <footer class="auth-footer font-label">
      <div class="auth-footer-inner">
        <div class="auth-footer-brand">LINGU FLOW - 1.0.0</div>
        <div class="auth-footer-links">
          <span class="auth-footer-link">PROTOCOL</span>
          <span class="auth-footer-link">DOCUMENTATION</span>
          <span class="auth-footer-link">SUPPORT</span>
        </div>
      </div>
    </footer>
  </div>
