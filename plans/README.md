...
| — | [KICKOFF-PROMPT-security-stack-a1-a3.md](./KICKOFF-PROMPT-security-stack-a1-a3.md) | Paste-ready agent prompt for security stack (#44–#46) — implemented on `fix/horizon-a-security-stack` |
| — | [KICKOFF-PROMPT-a7-docs-skills.md](./KICKOFF-PROMPT-a7-docs-skills.md) | **Next:** paste-ready agent prompt for A7 docs/skills (#50) |
...
```bash
gh issue list --label horizon-a
gh issue list --label horizon-b
```
...
- [`CLAUDE.md`](../CLAUDE.md) — agent source of truth (needs F-10 refresh)
- [`docs/DATABASE.md`](../docs/DATABASE.md) — current schema
- [`DEPLOYMENT.md`](../DEPLOYMENT.md) — Vercel + Railway + R2
