...
Artifact was produced against `feat/flashcards-lobby @ d5a5e87`. Current `main` includes that work and subsequent flashcards lobby (`eade46a`). Findings remain applicable unless a fix commit is grepped for F-01–F-04 (none of those fixes are present as of this plan).

---

## Next

→ [02-requirements-and-capacity.md](./02-requirements-and-capacity.md) for scoped NFRs and estimates that drive architecture choices.
